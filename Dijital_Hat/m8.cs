...
namespace Dijital_Hat
{
    public partial class m8 : Form
    {
        ...
        private void m8_Load(object sender, EventArgs e)
        {
            ...
            komut1.CommandText = ("Select * From deprem_9");
            ...
            textBox2.Text =m. ambrayses(D1x.Max(), mc8).ToString();
            textBox3.Text =m. ambrayses(D1y.Max(), mc8).ToString();
            textBox4.Text =m. ambrayses(D1z.Max(), mc8).ToString();
        }
