...
namespace Dijital_Hat
{
    public partial class m3 : Form
    {
        ...
        mo m = new mo();
        int index = 0;
        private void m3_Load(object sender, EventArgs e)
        {
            m_kisitla();
            timer1.Enabled = true;
            ...
            komut1.CommandText = ("Select * From deprem_4");
            ...
            textBox2.Text =m. ambrayses(D1x.Max(), mc3).ToString();
            textBox3.Text =m. ambrayses(D1y.Max(), mc3).ToString();
            textBox4.Text =m. ambrayses(D1z.Max(), mc3).ToString();
