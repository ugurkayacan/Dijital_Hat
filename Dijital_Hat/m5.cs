...
namespace Dijital_Hat
{
    public partial class m5 : Form
    {
        ...
        mo m = new mo();
        int index = 0;
        private void m5_Load(object sender, EventArgs e)
        {
            m_kisitla();
            timer1.Enabled = true;
            ...
            komut1.CommandText = ("Select * From deprem_6");
            ...
            textBox2.Text =m. ambrayses(D1x.Max(), mc5).ToString();
            textBox3.Text =m. ambrayses(D1y.Max(), mc5).ToString();
            textBox4.Text =m. ambrayses(D1z.Max(), mc5).ToString();
        }
