...
namespace Dijital_Hat
{
    public partial class m1 : Form
    {
        ...
        { 
            ...
            komut1.CommandText = ("Select * From deprem_2");
            ...
            textBox2.Text =m. ambrayses(D1x.Max(), mc1).ToString();
            textBox3.Text =m. ambrayses(D1y.Max(), mc1).ToString();
            textBox4.Text =m. ambrayses(D1z.Max(), mc1).ToString();
        }
