...
namespace Dijital_Hat
{
    public partial class m2 : Form
    {
        ...
        private void m2_Load(object sender, EventArgs e)
        {
            ...
            komut1.CommandText = ("Select * From deprem_3");
            ...
            textBox2.Text = m.ambrayses(D1x.Max(), mc2).ToString();
            textBox3.Text = m.ambrayses(D1y.Max(), mc2).ToString();
            textBox4.Text = m.ambrayses(D1z.Max(), mc2).ToString();
            m.m_kisitla();
        }
