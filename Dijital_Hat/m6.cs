...
namespace Dijital_Hat
{
    public partial class m6 : Form
    {
        ...
        private void m6_Load(object sender, EventArgs e)
        {
            ...
            komut1.CommandText = ("Select * From deprem_7");
            ...
            textBox2.Text =m. ambrayses(D1x.Max(), mc6).ToString();
            textBox3.Text =m. ambrayses(D1y.Max(), mc6).ToString();
            textBox4.Text =m. ambrayses(D1z.Max(), mc6).ToString();
        }
